...
from .views import JobPostingView,JobPostDetailView,JobPostListView,JobApplicationView,JobPostDetailPublic,JobPostingWithApplicantsView,RecruiterJobCompeletedInterviews,ApplicantsView,ApplicantDetailView,CandidateAppliedJobsView,SortedApplicantsView,CurrentCandidateProfile,CandidatePendingInterview,CandidateInterviewDone,CandidateIncompleteInterview,RequestReInterview,RecruiterJobCompeletedInterviews,ReinterviewRecruiterRequests
