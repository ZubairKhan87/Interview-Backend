...
from .views import JobPostingView,JobPostDetailView,JobPostListView,JobApplicationView,JobPostDetailPublic,JobPostingWithApplicantsView,ApplicantsView,ApplicantDetailView,CandidateAppliedJobsView,SortedApplicantsView,CurrentCandidateProfile,CandidateInterviewDone,CandidateIncompleteInterview,RequestReInterview
